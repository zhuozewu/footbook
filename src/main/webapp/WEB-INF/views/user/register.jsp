...
<div id="container">
    ...
    <div id="top">
        ...
        <div id="topWordMenu">
            <ul>
                <li>已有灵步账号，<a href="/user">请登录</a></li>
    ...
    <div id="banner">
        <div id="bannerTop">
            ...
            <div id="bannerWord2">如果你已经是灵步网注册用户，请直接<a href="login.jsp">登陆微博</a></div>
            <div id="bannerWord3">已经是灵步微博用户？<a href="login.jsp">登陆微博</a></div>
        </div>
        <div id="main">
            <form:form action="${pageContext.request.contextPath }/user" method="POST" modelAttribute="user" acceptCharset="utf-8" >
                <table width="765" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="71">&nbsp;</td>
                        <td width="86" align="center" valign="middle" class="wordleft">用 &nbsp;户&nbsp; 名</td>
                        <td width="189" align="center" valign="middle"><form:input path="user_name" type="text" class="form" onblur="checkUserId(img1,this)" onfocus="getfocus(this,img1)" /></td>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle"><form:input path="user_nick"  type="text" class="form" onfocus="getfocus(this,img2)" onblur="checkUserName(img2,this)" maxlength="20" /></td>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle" class="a"><form:input path="user_phone" type="text" class="form"  onblur="checkUserTel(img3,this)" onfocus="getfocus(this,img3)" /></td>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle"><form:input path="user_email" type="text" class="form" onblur="checkUserMail(img4,this)" onfocus="getfocus(this,img4)" /></td>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle"><input path="user_password" name="userPass" type="password" class="form" id="userPass" onfocus="getfocus(this,img5)" onblur="checkUserPass(img5,this)" maxlength="20" /></td>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle"><form:input path="user_password" type="password" class="form" id="userRpass" onblur="checkUserRpass(img6,this)" onfocus="getfocus(this,img6)" maxlength="20" /></td>
